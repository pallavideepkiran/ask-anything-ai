...
A quasi-agent is not a fully autonomous agent, but rather a structured wrapper around an LLM that simulates some agent-like behavior — such as processing messages, maintaining some context, or invoking tools — without the full reasoning, memory, or planning stack of a true agent.

quasi-agent teaches us several important lessons about building LLM-powered systems:
